            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bs04.jpg" width="50%">
                    </div>
                    <div class="col-2">
			                        <h1><?php echo $bname; ?></h1>
                        <p>Where the Crawdads Sing is part bildungsroman and part crime drama, centered around Kya, a wild and unkempt girl. The book follows the ups and downs of her life. She lives a lonely life, but her story is a hopeful one as well. With a little help, she's able to survive and even learn to read.</p>
                            <div class="rating">
