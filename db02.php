...
$bname = "Angels and Demons";
$bprice= "300";
$bimg= "img1/authorimg/author1.2.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author1.2.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>An explosive international thriller, Angels & Demons careens from enlightening epiphanies to dark truths as the battle between science and religion turns to war. Physicist Leonardo Vetra smelled burning flesh, and he knew it was his own. He stared up in terror at the dark figure looming over him.</p>
                            <div class="rating">
