		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <div class="row">
                        <div class="col-4"><a href="bio01.php?uname=<?php echo $uname?>">
                            <img src="img1/bio01.jpg"></a>
                        </div>

                        <div class="col-4"><a href="bio02.php?uname=<?php echo $uname?>">
                            <img src="img1/bio02.jpg"></a>
                        </div>

                        <div class="col-4"><a href="bio03.php?uname=<?php echo $uname?>">
                            <img src="img1/bio03.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio04.php?uname=<?php echo $uname?>">
                            <img src="img1/bio04.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio05.php?uname=<?php echo $uname?>">
                            <img src="img1/bio05.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio06.php?uname=<?php echo $uname?>">
                            <img src="img1/bio06.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio07.php?uname=<?php echo $uname?>">
                            <img src="img1/bio07.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio08.php?uname=<?php echo $uname?>">
                            <img src="img1/bio08.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio09.php?uname=<?php echo $uname?>">
                            <img src="img1/bio09.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bio10.php?uname=<?php echo $uname?>">
                            <img src="img1/bio10.jpg"></a>
                        </div>
