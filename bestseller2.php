            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bs02.jpg" width="50%">
                    </div>
                    <div class="col-2">
			                        <h1><?php echo $bname; ?></h1>
                        <p>It is a story about the childhood experiences of fraternal twins whose lives are destroyed by the "Love Laws" that lay down "who should be loved, and how. And how much."</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Arundhati Roy </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1997 </p>
