...
$bname = "Night Without End";
$bprice= "489";
$bimg= "img1/authorimg/author2.5.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author2.5.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>A BOAC airplane crash-lands on the Greenland ice cap far from its usual route after flying in a seemingly erratic fashion. An International Geophysical Year scientific research team based near the crash site rescues the surviving passengers and takes them to their cabin.</p>
                            <div class="rating">
