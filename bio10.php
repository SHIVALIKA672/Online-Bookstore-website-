...
$bname = "Vera (Mrs. Vladimir Nabokov)";
$bprice= "3000";
$bimg= "img1/bio10.jpg";
?>
<!DOCTYPE html>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bio10.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Everyone knows of Vladimir Nabokov — but what about his wife, Vera, whom he called “the best-humored woman I have ever known”? According to Schiff, she was a genius in her own right, supporting Vladimir not only as his partner, but also as his all-around editor and translator. And she kept up that trademark humor throughout it all, inspiring her husband’s work and injecting some of her own creative flair into it along the way.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Stacy Schiff </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year: 1999</p>
