...
$bgenre = "Home / Novel & Fiction";
$bname = "Oliver Twist";
$bprice= "129";
$bimg= "img1/novel09.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/img1/novel09.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The novel follows the journey of the titular character, Oliver Twist. Oliver, an orphan since birth, spends much of his childhood at a “child farm” (orphanage) with too many children and too little food. ... Eventually, after suffering repeated mistreatment, Oliver runs away and heads for London and is sold into apprenticeship with an undertaker.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Charles Dickens</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1838 </p>
