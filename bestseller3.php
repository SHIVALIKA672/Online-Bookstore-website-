            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bs03.jpg" width="50%">
                    </div>
                    <div class="col-2">
			                        <h1><?php echo $bname; ?></h1>
                        <p>Isaacson's latest book, The Code Breaker, breathlessly follows Doudna from a childhood spent trekking through the wilds of Hawaii to her pioneering work harnessing a bacterial defense system to rewrite the code of life—and the bitter patent battle that ensued—and ultimately winning the ultimate credit, the Nobel Prize.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Walter Isaacson </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:2021 </p>
