...
$bname = "Alice in Wonderland";
$bprice= "256";
$bimg= "img1/child08.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/child08.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Alice's Adventures in Wonderland by Lewis Carroll is a story about Alice who falls down a rabbit hole and lands into a fantasy world that is full of weird, wonderful people and animals. It is classic children's book that is also popular with adults.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Lewis Carroll </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1865 </p>
