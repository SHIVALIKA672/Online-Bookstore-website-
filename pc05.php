...
$bname = "The Devil and Miss Prym";
$bprice= "240";
$bimg= "img1/authorimg/author3.5.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author3.5.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The eternal conflict between good and evil is revisited in The Devil and Miss Prym. To tell this parable Coelho has transformed the Garden of Eden into a small village in the mountains, dozing in peaceful bliss, and the Fruit of Knowledge into gold bullion. The tempting serpent is an elegant traveler and talker who chooses Chantal Prym, a gorgeous young barmaid, as his mediator. Coelho dissects and manipulates his characters like puppets in this world of shadows, where death is not confined to cemeteries but remains closely linked to life. So, is man good or bad? And is God even interested in their fate? The answer can be found in a little more than 200 pages.</p>
                            <div class="rating">
