            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/img1/novel05.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Pride and Prejudice is set in rural England in the early 19th century, and it follows the Bennet family, which includes five very different sisters. Bennet is anxious to see all her daughters married, especially as the modest family estate is to be inherited by William Collins when Mr.Bennet dies.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Jane Austen</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1813 </p>
