		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <div class="row">
                        <div class="col-4"><a href="ya01.php?uname=<?php echo $uname?>">
                            <img src="img1/ya01.jpg"></a>
                        </div>

                        <div class="col-4"><a href="ya02.php?uname=<?php echo $uname?>">
                            <img src="img1/ya02.jpg"></a>
                        </div>

                        <div class="col-4"><a href="ya03.php?uname=<?php echo $uname?>">
                            <img src="img1/ya03.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya04.php?uname=<?php echo $uname?>">
                            <img src="img1/ya04.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya05.php?uname=<?php echo $uname?>">
                            <img src="img1/ya05.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya06.php?uname=<?php echo $uname?>">
                            <img src="img1/ya06.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya07.php?uname=<?php echo $uname?>">
                            <img src="img1/ya07.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya08.php?uname=<?php echo $uname?>">
                            <img src="img1/ya08.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya09.php?uname=<?php echo $uname?>">
                            <img src="img1/ya09.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ya10.php?uname=<?php echo $uname?>">
