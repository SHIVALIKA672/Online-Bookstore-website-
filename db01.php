...
$bgenre = "Home / Authors / Dan Brown";
$bname = "The Da Vinci Code";
$bprice= "248";
$bimg= "img1/authorimg/author11.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author11.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The Da Vinci Code follows "symbologist" Robert Langdon and cryptologist Sophie Neveu after a murder in the Louvre Museum in Paris causes them to become involved in a battle between the Priory of Sion and Opus Dei over the possibility of Jesus Christ and Mary Magdalene having had a child together.</p>
                            <div class="rating">
							...
							<p><b>Author :Dan Brown </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:2003 </p>
