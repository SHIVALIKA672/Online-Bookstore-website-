...
$bgenre = "Home / Series";
$bname = "Chronicles of Narnia";
$bprice= "1195";
$bimg= "img1/series0.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
                ...
                <?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/series06.1.jpg" width="65%" id="ProductImg">
                        <div class="small-img-row">

                            <div class="small-img-col-2">
                                <img src="img1/series06.1.jpg" width="50%" class="small-img">
                            </div>
                            <div class="small-img-col-2">
                                <img src="img1/series06.2.jpg" width="50%" class="small-img">
                            </div>
                    ...
                    <p><?php echo $bgenre; ?></p>
                        ...
                        <p>The Chronicles of Narnia is a series of fantasy novels by British author C. S. Lewis. ... Except in The Horse and His Boy, the protagonists are all children from the real world who are magically transported to Narnia, where they are sometimes called upon by the lion Aslan to protect Narnia from evil.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :C. S. Lewis </b></p>
                            <h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1950-56 </p>
