...
$bgenre = "Home / Authors / Chetan Bhagat";
$bname = "Five Point Someone";
$bprice= "195";
$bimg= "img1/authorimg/author4.2.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author4.2.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Chetan Bhagat's 'Five Point Someone' is a story about three friends and four years in IIT. Three hostel mates — Alok, Hari and Ryan get off to a bad start in IIT— they screw up the frst class quiz. While they try to make amends, things only get worse. ... Before they know it, they are at the lowest echelons of IIT society.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Chetan Bhagat </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:2004 </p>
