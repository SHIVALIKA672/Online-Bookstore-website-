    ...
    <div class="header">
		...
		<div class="container">
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <img src="img1/ya05.jpg" width="50%">
                    </div>
                    <div class="col-2">
                        <p>Home/Young Adult</p>
                        <h1>We were lairs</h1>
                        <p>It is centered on the wealthy, seemingly perfect Sinclair family, who spend every summer gathered on their private island. However, not every summer is the same—when something happens to Cadence during the summer of her fifteenth year, the four "Liars" (Cadence, Johnny, Gat and Mirren) re-emerge two years later to prompt Cadence to remember the incident.</p>
                            <div class="rating">
							...
							<p><b>Author:E. Lockhart </b></p>
                        <h4>Price : Rs299.00</h4>
