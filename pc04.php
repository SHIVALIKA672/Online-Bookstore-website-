...
$bgenre = "Home / Authors / Paulo Coelho";
$bname = "The Winner Stands Alone";
$bprice= "261";
$bimg= "img1/authorimg/author3.4.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author3.4.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Paulo Coelho offers us a mirror of our own society, where the cult of luxury and success makes us deaf to the truths murmured by our hearts. In Cannes, we meet those who have succeeded in the worlds of haute couture and cinema: a Russian millionaire, a reputed Middle-Eastern stylist, starlet Gabriela, an ambitious detective, and the model Jasmine. Money, power, and fame are their lives’ aims, and to achieve these they are prepared to do anything.</p>
                            <div class="rating">
                            ...
                            <p><b>Author : Paulo Coelho</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:2008 </p>
