...
$bname = "Puppet on a Chain";
$bprice= "492";
$bimg= "img1/authorimg/author2.4.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author2.4.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
						<p>It has the standard twisting plot, local atmospherics, and sardonic dialogue that were Maclean's trademarks as a story-teller. Maclean allows his protagonist to have a bantering sarcastic relationship with his assistants that provides a streak of humor as the plot unfolds.</p>
                            <div class="rating">
