...
$bgenre = "Home / Authors / Alistair MacLean";
$bname = "Ice Station Zebra";
$bprice= "446";
$bimg= "img1/authorimg/author22.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author22.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Drift ice Station Zebra, a British meteorological station built on an ice floe in the Arctic Sea, suffers a catastrophic oil fire; several of its men die, and their shelter and supplies are destroyed. The survivors hole up in one hut with little food and heat.</p>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star-haalf-o"></i>

                            </div>
                            <p><b>Author :Alistair MacLean </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year: 1960</p>
