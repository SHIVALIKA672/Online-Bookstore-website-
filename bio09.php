            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bio09.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The man, the myth, the legend: Steve Jobs, co-founder and CEO of Apple, is properly immortalized in Isaacson’s masterful biography. It divulges the details of Jobs’ little-known childhood and tracks his fateful path from garage engineer to leader of one of the largest tech companies in the world — not to mention his formative role in other legendary companies like Pixar, and indeed within the Silicon Valley ecosystem as a whole.</p>
                            <div class="rating">
