            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bio05.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>This “biography of the world’s most famous equation” is a one-of-a-kind take on the genre: rather than being the story of Einstein, it really does follow the history of the equation itself. From the origins and development of its individual elements (energy, mass, and light) to their ramifications in the twentieth century, Bodanis turns what could be an extremely dry subject into engaging fare for readers of all stripes.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :David Bodanis </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year: 2009 </p>
