...
$bname = "To All the Boys I`ve Loved Before";
$bprice= "342";
$bimg= "img1/ya06.jpg";
?>
<!DOCTYPE html>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/ya06.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>A teenage girl's secret love letters are exposed and wreak havoc on her love life. Lara Jean Covey writes letters to all of her past loves, the letters are meant for her eyes only. Until one day when all the love letters are sent out to her previous loves.</p>
                            <div class="rating">
