		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <h2 class="title">AUTHOR / Alistair MacLean</h2>
                    <div class="row">
                        <div class="col-4"><a href="am01.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author2.1.jpg"></a>
                        </div>

                        <div class="col-4"><a href="am02.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author22.jpg"></a>
                        </div>

                        <div class="col-4"><a href="am03.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author2.3.jpg"></a>
                        </div>
                        <div class="col-4"><a href="am04.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author2.4.jpg"></a>
                        </div>
                        <div class="col-4"><a href="am05.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author2.5.jpg"></a>
                        </div>
