            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/img1/novel10.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Outlander is a historical fantasy novel by Diana Gabaldon first published in 1991. Initially set around the time of the Second World War, it focuses on nurse Claire Beauchamp, who travels through time to 18th-century Scotland, where she finds adventure and romance with the dashing Jamie Fraser.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Diana Gabaldon</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1991 </p>
