            ...
            <div class="small-container">
                ...
                <?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/series07(1).jpg" width="65%" id="ProductImg">
                        <div class="small-img-row">

                            <div class="small-img-col-2">
                                <img src="img1/series07(1).jpg" width="50%" class="small-img">
                            </div>
                            <div class="small-img-col-2">
                                <img src="img1/series07(2).jpg" width="50%" class="small-img">
                            </div>
                    ...
                    <p><?php echo $bgenre; ?></p>
                        ...
                        <p>Nancy Drew is a fictional character, a sleuth in an American mystery series created by publisher Edward Stratemeyer as the female counterpart to his Hardy Boys series. ... The books are ghostwritten by a number of authors and published under the collective pseudonym Carolyn Keene.</p>
                            <div class="rating">
