...
$bname = "Sophie`s Choice";
$bprice= "399";
$bimg= "img1/novel07.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/img1/novel07.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>It concerns the relationships between three people sharing a boarding house in Brooklyn: Stingo, a young aspiring writer from the South, and the Jewish scientist Nathan Landau and his lover Sophie, a Polish Catholic survivor of the German Nazi concentration camps, whom he befriends.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :William Styron </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1979 </p>
