...
$bname = "The 3 Mistakes of My Life";
$bprice= "269";
$bimg= "img1/authorimg/author4.3.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author4.3.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The story recounts the life of three youths, Omi, Ishaan and Govind trying to make a life staying in small-town Gujarat. Given Govind's business acumen and Ishaan's love for cricket, the youngsters decide to open a shop that sells cricket goods.</p>
                            <div class="rating">
