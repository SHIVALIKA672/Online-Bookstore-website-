		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <div class="row">
                        <div class="col-4"><a href="author01.php?uname=<?php echo $uname?>">
                            <img src="img1/A1.1.png"></a>
                        </div>

                        <div class="col-4"><a href="author02.php?uname=<?php echo $uname?>">
                            <img src="img1/A2.1.png"></a>
                        </div>

                        <div class="col-4"><a href="author03.php?uname=<?php echo $uname?>">
                            <img src="img1/A3.1.png"></a>
                        </div>
                        <div class="col-4"><a href="author04.php?uname=<?php echo $uname?>">
                            <img src="img1/A4.1.png"></a>
                        </div>
                        <div class="col-4"><a href="author05.php?uname=<?php echo $uname?>">
                            <img src="img1/A5.1.png"></a>
                        </div>
