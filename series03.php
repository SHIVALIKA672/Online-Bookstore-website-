...
$bgenre = "Home / Series";
$bname = "Lord of the Rings Hobbit";
$bprice= "999";
            ...
            <div class="small-container">
                ...
                <?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/series03(2).jpg" width="50%" id="ProductImg">
                        <div class="small-img-row">

                            <div class="small-img-col-2">
                                <img src="img1/series03(1).jpg" width="50%" class="small-img">
                            </div>
                            <div class="small-img-col-2">
                                <img src="img1/series03(2).jpg" width="50%" class="small-img">
                            </div>
                    ...
                    <p><?php echo $bgenre; ?></p>
                        ...
                        <p>From homely beginnings in the Shire, a hobbit land reminiscent of the English countryside, the story ranges across Middle-earth, following the quest to destroy the One Ring mainly through the eyes of the hobbits Frodo, Sam, Merry and Pippin.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :J. R. R. Tolkien </b></p>
                            <h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1934 </p>
