		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <div class="row">
                        <div class="col-4"><a href="ws01.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author5.1.jpg"></a>
                        </div>

                        <div class="col-4"><a href="ws02.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author5.2.jpg"></a>
                        </div>

                        <div class="col-4"><a href="ws03.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author5.3.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ws04.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author5.4.jpg"></a>
                        </div>
                        <div class="col-4"><a href="ws05.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author5.5.jpg"></a>
                        </div>
