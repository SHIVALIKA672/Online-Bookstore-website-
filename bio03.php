...
$bname = "Barracoon: The Story of the Last Black Cargo";
$bprice= "1520";
$bimg= "img1/bio03.jpg";
?>
<!DOCTYPE html>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bio03.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>A prolific essayist, short story writer, and novelist, Hurston turned her hand to biographical writing in 1927 with this incredible work, kept under lock and key until it was published 2018. It’s based on Hurston’s interviews with the last remaining survivor of the Middle Passage slave trade, a man named Cudjo Lewis. Rendered in searing detail and Lewis’ highly affecting African-American vernacular, this biography of the “last black cargo” will transport you back in time to an era that, chillingly, is not nearly as far away from us as it feels.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Zora Neale Hurston </b></p>
