            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/child05.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>The stories tell mostly of Mowgli, an Indian boy who is raised by wolves and learns self-sufficiency and wisdom from the jungle animals. The book describes the social life of the wolf pack and, more fancifully, the justice and natural order of life in the jungle.</p>
                            <div class="rating">
                            ...
                            <p><b>Author:Rudyard Kipling </b></p>
