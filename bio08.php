...
$bname = "Savage Beauty: The Life of Edna St. Vincent Millay";
$bprice= "927";
$bimg= "img1/bio08.jpg";
?>
<!DOCTYPE html>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/bio08.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>This appropriately lyrical biography of brilliant Jazz Age poet and renowned feminist, Edna St. Vincent Millay, is indeed a perfect balance of savage and beautiful. While Millay’s poetic work was delicate and subtle, the woman herself was feisty and unpredictable, harboring unusual and occasionally destructive habits that Milford fervently explores.</p>
                            <div class="rating">
                            ...
                            <p><b>Author : Nancy Milford</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:2001 </p>
