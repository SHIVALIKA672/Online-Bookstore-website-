            ...
            <div class="small-container">
                ...
                <?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/series05(1).jpg" width="65%" id="ProductImg">
                        <div class="small-img-row">

                            <div class="small-img-col-2">
                                <img src="img1/series05(1).jpg" width="50%" class="small-img">
                            </div>
                            <div class="small-img-col-2">
                                <img src="img1/series05(2).png" width="50%" class="small-img">
                            </div>
