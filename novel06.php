...
$bname = "Wuthering Heights";
$bprice= "110";
$bimg= "img1/novel06.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/img1/novel06.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Wuthering Heights is an 1847 novel by Emily Brontë, published under the pseudonym Ellis Bell. It concerns two families of the landed gentry living on the West Yorkshire moors, the Earnshaws and the Lintons, and their turbulent relationships with Earnshaw's adopted son, Heathcliff.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Emily Brontë</b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1847 </p>
