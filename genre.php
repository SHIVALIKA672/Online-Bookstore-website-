		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <div class="row">
                        <div class="col-4"><a href="faults.php?uname=<?php echo $uname?>">
                            <img src="img1/ya01.jpg"></a>
                        </div>

                        <div class="col-4"><a href="thesun.php?uname=<?php echo $uname?>">
                            <img src="img1/ya02.jpg"></a>
                        </div>

                        <div class="col-4"><a href="annanfrench.php?uname=<?php echo $uname?>">
                            <img src="img1/ya03.jpg"></a>
                        </div>
                        <div class="col-4"><a href="bothdie.php?uname=<?php echo $uname?>">
                            <img src="img1/ya04.jpg"></a>
                        </div>
                        <div class="col-4"><a href="liars.php?uname=<?php echo $uname?>">
                            <img src="img1/ya05.jpg"></a>
                        </div>
                        <div class="col-4"><a href="alltheboys.php?uname=<?php echo $uname?>">
                            <img src="img1/ya06.jpg"></a>
                        </div>
                        <div class="col-4"><a href="shatterme.php?uname=<?php echo $uname?>">
                            <img src="img1/ya07.jpg"></a>
                        </div>
                        <div class="col-4"><a href="cinder.php?uname=<?php echo $uname?>">
                            <img src="img1/ya08.jpg"></a>
                        </div>
                        <div class="col-4"><a href="simon.php?uname=<?php echo $uname?>">
                            <img src="img1/ya09.jpg"></a>
                        </div>
                        <div class="col-4"><a href="fangirl.php?uname=<?php echo $uname?>">
                            <img src="img1/ya10.jpg"></a>
                        </div>
