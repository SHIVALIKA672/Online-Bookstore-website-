...
$bname = "Arabian Nights";
$bprice= "349";
$bimg= "img1/child06.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/child06.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>"The Arabian Nights" is a magnificent collection of ancient tales told by the sultana Scheherazade, who relates them as entertainment for her jealous and murderous husband, hoping to keep him amused and herself alive.</p>
                            <div class="rating">
                            ...
                            <p><b>Author:Tahir Shah </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1885 </p>
