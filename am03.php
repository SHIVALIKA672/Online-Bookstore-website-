...
$bname = "Where Eagles Dare";
$bprice= "652";
$bimg= "img1/authorimg/author2.3.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author2.3.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Logline. During World War Two a team of British spies attempt to rescue an American general from an impregnable castle in the German Alps but, when they discover there are double agents in the group, the team must discover who the traitors are and then escape against enormous odds.</p>
                            <div class="rating">
