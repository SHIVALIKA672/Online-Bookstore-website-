...
$bname = "The Guns of Navarone";
$bprice= "345";
$bimg= "img1/authorimg/author2.1.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author2.1.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>

                        <p>The story concerns the efforts of an Allied commando team to destroy a seemingly impregnable German fortress that threatens Allied naval ships in the Aegean Sea and prevents over 1,200 isolated British Army soldiers from being rescued</p>
                            <div class="rating">
