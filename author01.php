		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <h2 class="title">AUTHOR / Dan Brown</h2>
                    <div class="row">
                        <div class="col-4"><a href="db01.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author11.jpg"></a>
                        </div>

                        <div class="col-4"><a href="db02.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author1.2.jpg"></a>
                        </div>

                        <div class="col-4"><a href="db03.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author1.3.jpg"></a>
                        </div>
                        <div class="col-4"><a href="db04.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author1.4.jpg"></a>
                        </div>
                        <div class="col-4"><a href="db05.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author1.5.jpg"></a>
                        </div>
