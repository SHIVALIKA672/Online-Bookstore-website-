...
$bname = "Aesop`s Fables";
$bprice= "405";
$bimg= "img1/child07.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/child07.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>These fables, which were short in structure, being one page at the very most, had one goal. ... This goal was to deliver a moral. In "The Boy Who Cried Wolf," also known as "The Shepherd's Boy And The Wolf," delivers the moral that a liar cannot be believed even when telling the truth.</p>
                            <div class="rating">
                            ...
                            <p><b>Author :Aesop </b></p>
							<h4>Price : Rs <?php echo $bprice; ?></h4>
                        <p>Publish year:1484 </p>
