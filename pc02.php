...
$bname = "The spy";
$bprice= "180";
$bimg= "img1/authorimg/author3.2.jpg";
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="small-container">
				...
				<?php
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/authorimg/author3.2.jpg" width="50%">
                    </div>
                    <div class="col-2">
					<p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>Paulo Coelho pens a gripping and part fictional tale on the life of a legendary dancer cum falsely accused spy named Mata Hari in his new novel, The Spy. He spins a riveting autobiographical account on the dancer's life through a fictional letter penned by the dancer herself addressing to her lawyer.</p>
                            <div class="rating">
