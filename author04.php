		...
		<div class="container">
            ...
            <div class="genres">
                <div class="small-container">
                    ...
                    <h2 class="title">AUTHOR / Chetan Bhagat</h2>
                    <div class="row">
                        <div class="col-4"><a href="cb01.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author4.1.jpg"></a>
                        </div>

                        <div class="col-4"><a href="cb02.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author4.2.jpg"></a>
                        </div>

                        <div class="col-4"><a href="cb03.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author4.3.jpg"></a>
                        </div>
                        <div class="col-4"><a href="cb04.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author4.4.jpg"></a>
                        </div>
                        <div class="col-4"><a href="cb05.php?uname=<?php echo $uname?>">
                            <img src="img1/authorimg/author4.5.jpg"></a>
                        </div>
