    ...
    <div class="header">
		...
		<div class="container">
            ...
            <div class="small-container">
                <div class="row">
                    <div class="col-2">
                        <img src="img1/ya07.jpg" width="50%">
                    </div>
                    <div class="col-2">
                        <p>Home/Young Adult</p>
                        <h1>Shatter Me</h1>
                        <p>Shatter Me follows the narrative of Juliette Ferrars, a 17-year-old girl with a paralyzing and killing touch. She can take living organisms' energy. The book starts out with Juliette in an asylum due to the fact that she murdered a small boy three years prior, in a store, using her unusual touch.</p>
                            <div class="rating">
							...
							<p><b>Author: Tahereh Mafi</b></p>
                        <h4>Price : Rs299.00</h4>
                        <p>Publish Year:2011 </p>
