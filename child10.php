            ...
            <div class="small-container">
                <div class="row">
					...
					$result = $stmt->get_result();
										?>
                    <div class="col-2">
                        <img src="img1/child10.jpg" width="50%">
                    </div>
                    <div class="col-2">
                        <p><?php echo $bgenre; ?></p>
                        <h1><?php echo $bname; ?></h1>
                        <p>A free-spirited and mischievous young boy who can fly and never grows up, Peter Pan spends his never-ending childhood having adventures on the mythical island of Neverland as the leader of the Lost Boys, interacting with fairies, pirates, mermaids, Native Americans, and occasionally ordinary children from the world outside Neverland.</p>
                            <div class="rating">
							...
							<p><b>Author:J.M. Barrie </b></p>
                        <h4>Price : Rs <?php echo $bprice; ?></h4>
						<p>Publish Year:2018 </p>
